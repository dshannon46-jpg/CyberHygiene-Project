...
**Reference:** System Security Plan Version 2.6
...
| POA&M-034 | Login banners not implemented on all systems | 3.1.9 (AC-8) | 02/15/2026 | DoD-standard banner in /etc/issue and /etc/issue.net. SSH Banner configured. Verified: `sshd -T \| grep banner`. **Deployed: dc1, labrat, engineering, accounting. All 4 CPN systems fully deployed as of 02/21/2026.** | COMPLETED |
...
| 2.9 | 02/21/2026 | D. Shannon | **ACCOUNTING WORKSTATION DEPLOYMENT:** Accounting (192.168.1.113) returned from maintenance. CMMC controls deployed via fix-engineering.sh: USBGuard (POA&M-044/3.8.7), session lock 15-min idle via GNOME dconf (POA&M-029/3.1.10), DoD-standard login banners in /etc/issue and /etc/issue.net (POA&M-034/3.1.9). All 4 CPN systems (dc1, labrat, engineering, accounting) now fully hardened. Pending caveats removed from POA&M-029, 034, 044. No SPRS impact — points already credited at initial deployment. |
