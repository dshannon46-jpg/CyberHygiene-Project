...
- TCC-AAP-001 = Audit and Accountability Policy (Approved 02/15/2026)
- TCC-CMP-001 = Configuration Management Policy (Approved 02/15/2026)
- TCC-ATP-001 = Security Awareness and Training Policy (Approved 02/15/2026)
- TCC-IAP-001 = Identification and Authentication Policy (Approved 02/15/2026)
- TCC-SCP-001 = System and Communications Protection Policy (Approved 02/15/2026)
...
| 3.1.9 | Provide privacy and security notices consistent with applicable laws | ✅ Implemented | Acceptable Use Policy | TCC-AUP-001 | Section 2.6 | DoD-standard login banners deployed on dc1 (02/15/2026). /etc/issue, /etc/issue.net, SSH Banner configured. |
| 3.1.10 | Use session lock with pattern-hiding displays to prevent access and viewing of data after period of inactivity | ✅ Implemented | Acceptable Use Policy | TCC-AUP-001 | Section 2.3 | GNOME dconf 15-min idle lock on dc1 (02/15/2026). Settings locked via dconf. |
...
| Control ID | Control Title | Implementation Status | Policy Document | Policy ID | Section | Notes |
|------------|---------------|----------------------|-----------------|-----------|---------|-------|
| 3.2.1 | Ensure managers, system administrators, and users are made aware of security risks and applicable policies | **NOT MET** | Security Awareness and Training Policy | TCC-ATP-001 | Section 3.1 | Policy approved 02/15/2026. Training program not yet conducted. POA&M-006 (-3 pts). Target: 03/31/2026. |
| 3.2.2 | Ensure personnel are trained to carry out their assigned information security-related duties | **NOT MET** | Security Awareness and Training Policy | TCC-ATP-001 | Section 3.2 | Policy approved 02/15/2026. Role-based training not yet conducted. POA&M-006 (-3 pts). Target: 03/31/2026. |
| 3.2.3 | Provide security awareness training on recognizing and reporting potential indicators of insider threat | **NOT MET** | Security Awareness and Training Policy | TCC-ATP-001 | Section 8.1 | Policy approved 02/15/2026. Insider threat awareness training not yet delivered. POA&M-006 (-1 pt). Target: 03/31/2026. |
...
| Control ID | Control Title | Implementation Status | Policy Document | Policy ID | Section | Notes |
|------------|---------------|----------------------|-----------------|-----------|---------|-------|
| 3.4.1 | Create and retain system audit logs and records to enable monitoring and analysis of security-relevant events | Implemented | System Config | TCC-AAP-001 | auditd, Wazuh | AU policy Q4 2025 |
| 3.4.2 | Ensure that the actions of individual system users can be uniquely traced | Implemented | System Config | TCC-AAP-001 | auditd rules | FreeIPA + auditd |
| 3.4.3 | Review and update logged events | Implemented | System Config | TCC-AAP-001 | auditd config | Quarterly review |
| 3.4.4 | Alert in the event of an audit logging process failure | Implemented | System Config | TCC-AAP-001 | auditd config | Admin email alerts |
| 3.4.5 | Correlate audit record review, analysis, and reporting processes for investigation and response | Implemented | Incident Response Policy + System Config | TCC-IRP-001 + TCC-AAP-001 | IR Section 2.5 | Wazuh correlation |
| 3.4.6 | Provide audit record reduction and report generation | Implemented | System Config | TCC-AAP-001 | Wazuh | Dashboard reporting |
| 3.4.7 | Provide a system capability that compares and synchronizes internal system clocks with an authoritative source | Implemented | System Config | TCC-AAP-001 | chronyd | NTP time sync |
| 3.4.8 | Protect audit information and audit logging tools from unauthorized access | Implemented | System Config | TCC-AAP-001 | File permissions | /var/log/audit root:root 600 |
| 3.4.9 | Limit management of audit logging functionality to a subset of privileged users | Implemented | System Config | TCC-AAP-001 | sudo rules | ISSO/admin only |
| 3.4.10 | Allocate audit log storage capacity | Implemented | System Config | TCC-AAP-001 | Partition sizing | /var/log/audit separate partition |
| 3.4.11 | Provide warning when allocated audit record storage volume reaches organization-defined percentage of maximum | Implemented | System Config | TCC-AAP-001 | Wazuh alerts | 75% threshold alert |
| 3.4.12 | Back up audit records at least weekly onto a different system or media than the system being audited | Implemented | System Config + Backup Procedures | TCC-AAP-001 | ReaR | Weekly USB backup |
...
| Control ID | Control Title | Implementation Status | Policy Document | Policy ID | Section | Notes |
|------------|---------------|----------------------|-----------------|-----------|---------|-------|
| 3.5.1 | Establish and maintain baseline configurations and inventories of organizational systems | Implemented | Configuration Management Baseline | TCC-CMP-001 | Entire doc | CM policy planned Q1 2026 |
| 3.5.2 | Employ automated mechanisms to maintain an up-to-date, complete, accurate, and readily available baseline configuration | Implemented | System Config | TCC-CMP-001 | Wazuh FIM | File integrity monitoring |
| 3.5.3 | Define, document, approve, and enforce physical and logical access restrictions associated with changes to systems | Implemented | System Config | TCC-CMP-001 | Change control | ISSO approval required |
| 3.5.4 | Employ the principle of least functionality by configuring systems to provide only essential capabilities | Implemented | System Config | TCC-CMP-001 | Minimal install | Rocky Linux minimal + required |
| 3.5.5 | Restrict, disable, or prevent the use of nonessential programs, functions, ports, protocols, and services | Implemented | System Config | TCC-CMP-001 | Firewall | Restrictive firewall rules |
| 3.5.6 | Apply deny-by-default and allow-by-exception policy for allowing specific ports, protocols, and services | Implemented | Network Config | TCC-CMP-001 | pfSense | Default deny ruleset |
| 3.5.7 | Restrict, disable, or prevent the use of nonessential programs, functions, ports, protocols, and services | Implemented | System Config | TCC-CMP-001 | SELinux | Enforcing mode |
| 3.5.8 | Apply deny-by-default, allow-by-exception policy to control the execution of authorized software programs | Implemented | System Config | TCC-CMP-001 | Application whitelist | dnf package management only |
| 3.5.9 | Control and monitor user-installed software | Implemented | System Config | TCC-CMP-001 | Wazuh FIM | Software installation monitoring |
| 3.5.10 | Employ automated mechanisms to detect the presence of unauthorized software on organizational systems and notify designated personnel | Implemented | System Config | TCC-CMP-001 | Wazuh FIM | Real-time file monitoring |
...
| Control ID | Control Title | Implementation Status | Policy Document | Policy ID | Section | Notes |
|------------|---------------|----------------------|-----------------|-----------|---------|-------|
| 3.5.1 | Identify system users, processes acting on behalf of users, and devices | ✅ Implemented | Identification and Authentication Policy | TCC-IAP-001 | Section 3.1 | FreeIPA unique user accounts |
| 3.5.2 | Authenticate (or verify) the identities of users, processes, or devices | ✅ Implemented | Identification and Authentication Policy | TCC-IAP-001 | Section 3.1 | Kerberos authentication via FreeIPA |
| 3.5.3 | Use multifactor authentication for local and network access to privileged accounts and for network access to non-privileged accounts | **NOT MET** | Identification and Authentication Policy | TCC-IAP-001 | Section 3.1.3 | MFA not implemented. POA&M-004 (**-5 pts**). FreeIPA OTP planned. Target: 03/31/2026. |
| 3.5.4 | Employ replay-resistant authentication mechanisms for network access to privileged and non-privileged accounts | ✅ Implemented | Identification and Authentication Policy | TCC-IAP-001 | Section 3.5 | Kerberos ticket-based (replay-resistant) |
| 3.5.5 | Prevent reuse of identifiers for a defined period | ✅ Implemented | Identification and Authentication Policy | TCC-IAP-001 | Section 3.3 | FreeIPA account lifecycle management |
| 3.5.6 | Disable identifiers after a defined period of inactivity | ✅ Implemented | Identification and Authentication Policy | TCC-IAP-001 | Section 3.3 | Quarterly access review |
| 3.5.7 | Enforce a minimum password complexity and change of characters when new passwords are created | ✅ Implemented | Identification and Authentication Policy | TCC-IAP-001 | Section 3.3 | FreeIPA: 14-char min, 3 classes, 90-day expiry |
| 3.5.8 | Prohibit password reuse for a specified number of generations | ✅ Implemented | Identification and Authentication Policy | TCC-IAP-001 | Section 3.3 | FreeIPA: 24 password history |
| 3.5.9 | Allow temporary password use for system logons with an immediate change to a permanent password | ✅ Implemented | Identification and Authentication Policy | TCC-IAP-001 | Section 3.3 | Force change on first login |
| 3.5.10 | Store and transmit only cryptographically-protected passwords | ✅ Implemented | Identification and Authentication Policy | TCC-IAP-001 | Section 3.5 | FIPS 140-2, Kerberos/TLS only |
| 3.5.11 | Obscure feedback of authentication information | ✅ Implemented | Identification and Authentication Policy | TCC-IAP-001 | Section 3.4 | Password masking, no credential logging |
...
| Control ID | Control Title | Implementation Status | Policy Document | Policy ID | Section | Notes |
|------------|---------------|----------------------|-----------------|-----------|---------|-------|
| 3.7.1 | Perform maintenance on organizational systems | ✅ Implemented | Configuration Management Policy | TCC-CMP-001 | Section 3.2 | Change management process |
| 3.7.2 | Provide controls on the tools, techniques, mechanisms, and personnel used to conduct system maintenance | ✅ Implemented | Configuration Management Policy | TCC-CMP-001 | Section 3.4 | Access restrictions for change |
| 3.7.3 | Ensure equipment removed for off-site maintenance is sanitized of any CUI | ✅ Implemented | Physical and Media Protection Policy | TCC-PE-MP-001 | Part 2, Section 2.6 | LUKS erase procedures |
| 3.7.4 | Check media containing diagnostic and test programs for malicious code before the media are used in organizational systems | ✅ Implemented | System and Information Integrity Policy | TCC-SI-001 | Section 2.3 | YARA scan before use |
| 3.7.5 | Require multifactor authentication to establish nonlocal maintenance sessions and terminate such sessions when nonlocal maintenance is complete | **NOT MET** | Identification and Authentication Policy | TCC-IAP-001 | Section 3.1.3 | Dependent on MFA implementation (POA&M-004) |
| 3.7.6 | Supervise the maintenance activities of maintenance personnel without required access authorization | ✅ N/A | Personnel Security Policy | TCC-PS-001 | Section 2.7 | Solopreneur — sole operator |
...
| 3.8.7 | Control the use of removable media on system components | ✅ Implemented | Physical and Media Protection Policy | TCC-PE-MP-001 | Part 2, Section 2.7 | USBGuard deployed on dc1 (02/15/2026). Device-specific policy with Wazuh monitoring. |
...
| Control ID | Control Title | Implementation Status | Policy Document | Policy ID | Section | Notes |
|------------|---------------|----------------------|-----------------|-----------|---------|-------|
| 3.11.1 | Periodically assess the risk to organizational operations, assets, and individuals from organizational systems | **NOT MET** | Risk Management Policy and Procedures | TCC-RA-001 | Section 2.3 | Policy approved but first formal risk assessment not conducted. POA&M-035 (-3 pts). Target: 04/30/2026. |
...
| Control ID | Control Title | Implementation Status | Policy Document | Policy ID | Section | Notes |
|------------|---------------|----------------------|-----------------|-----------|---------|-------|
| 3.12.1 | Periodically assess the security controls in organizational systems to determine if the controls are effective in their application | **NOT MET** | Risk Management Policy | TCC-RA-001 | Section 2.3 | Formal security control assessment not yet conducted. POA&M-011 (-3 pts). Feb 9 gap analysis contributes. Target: 03/31/2026. |
| 3.12.2 | Develop and implement plans of action designed to correct deficiencies and reduce or eliminate vulnerabilities | ✅ Implemented | POA&M | N/A | Unified POA&M v2.4 | Active POA&M maintained since 10/26/2025 |
| 3.12.3 | Monitor security controls on an ongoing basis to ensure continued effectiveness | ✅ Implemented | System and Information Integrity Policy | TCC-SI-001 | Section 2.4 | Wazuh continuous monitoring, OpenSCAP quarterly |
| 3.12.4 | Develop, document, and periodically update system security plans | ✅ Implemented | System Security Plan | N/A | SSP v2.3 | Active SSP maintained and updated |
...
| Control ID | Control Title | Implementation Status | Policy Document | Policy ID | Section | Notes |
|------------|---------------|----------------------|-----------------|-----------|---------|-------|
| 3.13.1 | Monitor, control, and protect communications at external boundaries | Implemented | System Config | TCC-SCP-001 | Suricata IDS | pfSense firewall + Suricata |
| 3.13.2 | Employ architectural designs, software development techniques, and systems engineering principles that promote effective information security | Implemented | System Config | TCC-SCP-001 | Defense in depth | Layered security approach |
| 3.13.3 | Separate user functionality from system management functionality | Implemented | System Config | TCC-SCP-001 | User separation | Standard vs admin accounts |
| 3.13.4 | Prevent unauthorized and unintended information transfer via shared system resources | Implemented | System Config | TCC-SCP-001 | SELinux | Type enforcement |
| 3.13.5 | Deny network communications traffic by default and allow network communications traffic by exception | Implemented | Network Config | TCC-SCP-001 | pfSense | Default deny firewall |
| 3.13.6 | Deny network communications traffic by default and allow network communications traffic by exception (internal systems) | Implemented | Network Config | TCC-SCP-001 | firewalld | Host-based firewalls |
| 3.13.7 | Prevent remote devices from simultaneously establishing non-remote connections with organizational systems | Implemented | Network Config | TCC-SCP-001 | Routing | Split tunneling prevented |
| 3.13.8 | Implement cryptographic mechanisms to prevent unauthorized disclosure of CUI during transmission | Implemented | Network Config | TCC-SCP-001 | TLS/SSH | All remote access encrypted |
| 3.13.9 | Terminate network connections associated with communications sessions at the end of the sessions | Implemented | System Config | TCC-SCP-001 | Timeouts | SSH session timeouts |
| 3.13.10 | Establish and manage cryptographic keys for cryptography employed in organizational systems | Implemented | System Config | TCC-SCP-001 | Key management | LUKS key management |
| 3.13.11 | Employ FIPS-validated cryptography when used to protect the confidentiality of CUI | ✅ Implemented | System Config | TCC-SCP-001 | FIPS mode | FIPS 140-2 validated |
| 3.13.12 | Prohibit remote activation of collaborative computing devices | ✅ N/A | System Config | TCC-SCP-001 | N/A | No webcams/microphones on systems |
| 3.13.13 | Control and monitor the use of mobile code | Implemented | Network Config | TCC-SCP-001 | Browser config | JavaScript restricted |
| 3.13.14 | Control and monitor the use of Voice over Internet Protocol (VoIP) technologies | ✅ N/A | System Config | TCC-SCP-001 | N/A | No VoIP systems |
| 3.13.15 | Protect the authenticity of communications sessions | Implemented | System Config | TCC-SCP-001 | SSH, TLS | Certificate-based auth |
...
| TCC-AAP-001 | Audit and Accountability Policy | 11KB | AU | 12 | 02/15/2026 |
| TCC-CMP-001 | Configuration Management Policy | 14KB | CM | 11 | 02/15/2026 |
| TCC-ATP-001 | Security Awareness and Training Policy | 14KB | AT | 4 | 02/15/2026 |
| TCC-IAP-001 | Identification and Authentication Policy | 15KB | IA | 11 | 02/15/2026 |
| TCC-SCP-001 | System and Communications Protection Policy | 23KB | SC | 16+ | 02/15/2026 |

**Total Policy Coverage:** 100+ individual controls across all 14 NIST 800-171 control families

**All policies located at:** `/backup/personnel-security/policies/` (LUKS-encrypted partition)

---

## Recently Approved Policies (February 15, 2026)

| Policy ID | Policy Title | Control Families | Approval Date | Status |
|-----------|-------------|------------------|---------------|---------|
| TCC-AAP-001 | Audit and Accountability Policy v1.0 | AU | 02/15/2026 | **APPROVED** |
| TCC-CMP-001 | Configuration Management Policy v1.0 | CM | 02/15/2026 | **APPROVED** |
| TCC-IAP-001 | Identification and Authentication Policy v1.0 | IA | 02/15/2026 | **APPROVED** |
| TCC-ATP-001 | Security Awareness and Training Policy v1.0 | AT | 02/15/2026 | **APPROVED** |
| TCC-SCP-001 | System and Communications Protection Policy v1.0 | SC | 02/15/2026 | **APPROVED** |

*All approved by Donald E. Shannon, System Owner / ISSO*
...
**By Status:**
- **100% Documented (with ✅):** IR (8), RA (5), PS (8), PE (15), MP (9), SI (12), AU (12), CM (11), SC (16), IA (10), MA (5) = 111 controls
- **NOT MET (with POA&M):** 3.5.3 MFA (-5), 3.2.1/3.2.2/3.2.3 Training (-7), 3.11.1 Risk Assessment (-3), 3.12.1 Security Assessment (-3), 3.6.3 IR Testing (-1), 3.7.5 Nonlocal Maintenance MFA (dependent on 3.5.3) = 7 controls
- **N/A (documented):** PE-8, PE-17, RA-6, RA-8, SC-12, SC-14, MA-6, and several solopreneur-specific = ~10 controls

**Total NIST 800-171 Rev 2 Controls:** 110 requirements (14 families)
**TCC Policy-Documented Controls:** 100+ (91% of total)
**TCC Technically Implemented:** 103+ (94% of total)
**SPRS Score:** 91/110 (82.7%) — 19 points remaining deficit
...
| 2.0 | 02/15/2026 | D. Shannon | CMMC gap analysis remediation: Added 5 approved policies (AU, CM, AT, IA, SC). Added IA, MA, CA sections. Updated 3.1.9/3.1.10 to Implemented. Updated 3.8.7 USBGuard to Implemented. Corrected 3.5.3 MFA as NOT MET (-5 pts). Corrected 3.11.1 as NOT MET. Corrected 3.2.1-3.2.3 as NOT MET. Updated all policy references from draft/planned to approved IDs. |
